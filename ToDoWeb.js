...
const AddTaskSectionRef = document.getElementById("AddTaskSection");
...
const helperTextTitleRef = document.getElementById("helpertext_title");
const helperTextDescriptionRef = document.getElementById(
  "helpertext_description"
);
const helperTextStatusRef = document.getElementById("helpertext_status");
const helperTextPriorityRef = document.getElementById("helpertext_priority");

const HelperTextArray = [
  helperTextTitleRef,
  helperTextDescriptionRef,
  helperTextStatusRef,
  helperTextPriorityRef,
];
